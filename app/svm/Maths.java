...
public class Maths {
	/*
	 * public static double area2(DPoint a, DPoint b, DPoint c) { return
	 * (a.x*b.y - a.y*b.x + a.y*c.x - a.x*c.y + b.x*c.y - b.y*c.x); }
	 * 
	 * public static boolean left(DPoint a, DPoint b, DPoint c) { return
	 * area2(a,b,c) > 0.0; }
	 * 
	 * public static boolean leftOn(DPoint a, DPoint b, DPoint c) { return
	 * area2(a,b,c) >= 0.0; }
	 * 
	 * public static boolean right(DPoint a, DPoint b, DPoint c) { return
	 * area2(a,b,c) < 0.0; }
	 * 
	 * public static boolean rightOn(DPoint a, DPoint b, DPoint c) { return
	 * area2(a,b,c) <= 0.0; }
	 * 
	 * public static boolean collinear(DPoint a, DPoint b, DPoint c) { return
	 * area2(a,b,c) == 0.0; }
	 * 
	 * public static boolean intersectProp(DPoint a, DPoint b, DPoint c, DPoint
	 * d) { return area2(a,b,c)*area2(a,b,d) < 0 && area2(c,d,a)*area2(c,d,b) <
	 * 0; }
	 * 
	 * public static boolean between(DPoint a, DPoint b, DPoint c) {
	 * if(!collinear(a,b,c)) return false;
	 * 
	 * if(a.x != b.x) return (a.x <= c.x && c.x <= b.x) || (b.x <= c.x && c.x <=
	 * a.x); else return (a.y <= c.y && c.y <= b.y) || (b.y <= c.y && c.y <=
	 * a.y); }
	 * 
	 * public static boolean intersect(DPoint a, DPoint b, DPoint c, DPoint d) {
	 * if(intersectProp(a,b,c,d)) return true; else if(between(a,b,c) ||
	 * between(a,b,d) || between(c,d,a) || between(c,d,b)) return true; else
	 * return false; }
	 * 
	 * public static double height(DPoint a, DPoint b, DPoint c) { if((a.x ==
	 * b.x) && (a.y == b.y)) return a.distance(c);
	 * 
	 * double area = Math.abs(area2(a,b,c)); return(area/a.distance(b)); }
	 * 
	 * public static double distance(DPoint a, DPoint b, DPoint c) { double
	 * dist; DPoint a1; DPoint b1;
	 * 
	 * a1 = new DPoint(a.y - b.y + a.x, b.x - a.x + a.y); b1 = new DPoint(a.y -
	 * b.y + b.x, b.x - a.x + b.y);
	 * 
	 * 
	 * if(right(a,a1,c) && left(b,b1,c)) return height(a,b,c); else
	 * if(leftOn(a,a1,c)) return a.distance(c); else return b.distance(c); }
	 * 
	 * 
	 ...
	 * 
	 * public static double distance(DStroke s1, DStroke s2) { double dist =
	...
	/*
	 * public static void main(String[] argv) { //2 1 0 100.0 106.0 1 199.0
	 * 106.0 //2 2 0 146.0 214.0 1 153.0 111.0 DPoint a = new
	 * DPoint(100.0,106.0); DPoint b = new DPoint(199.0,106.0); DPoint c = new
	 * DPoint(146.0,214.0); DPoint d = new DPoint(153.0,111.0);
	 * 
	 * DPoint a = new DPoint(0.0,0.0); DPoint b = new DPoint(100.0,0.0); DPoint
	 * c = new DPoint(50.0,14.0); DPoint d = new DPoint(c.x,c.y+10);
	 * 
	 * DStroke s1 = new DStroke(); DStroke s2 = new DStroke(); s1.add(a);
	 * s1.add(b); s2.add(c); //s2.add(d);
	 * 
	 * System.out.println(Geom.distance(b,a,c,d));
	 * System.out.println(Geom.distance(s1,s2));
	 * System.out.println(Geom.distance(s1,s2,1));
	 * 
	 * s1.equidistant(1); System.out.println("s1.equidistant(1);");
	 * 
	 ...
	 * 
	 * f[10] = 1; f[11] = 1; f[12] = 1; f[13] = 2; f[14] = 1; f[15] = 2;
	 * 
	 * ArrayList v = Geom.locateLocalExtrema(f,0.0);
	 * 
	 ...
	 * 
	 * System.out.println((new DPoint(3,2)).middlePoint(new
	 * DPoint(1,3)).toString()); System.out.println((new
	 * DPoint(1,3)).middlePoint(new DPoint(3,2)).toString());
	 * 
	 * System.out.println((new DPoint(1,3)).to(new DPoint(3,2)).toString());
	 * 
	 * DStroke s = new DStroke(); s.add(new DPoint(0,0)); s.add(new
	 * DPoint(0.5,0)); s.add(new DPoint(1,0));
	 * System.out.println(s.toString()+": " +s.norm());
	 * 
	 * s = new DStroke(); s.add(new DPoint(0,0)); s.add(new DPoint(0,0.5));
	 * s.add(new DPoint(0,1)); System.out.println(s.toString()+": " +s.norm());
	 * 
	 * s = new DStroke(); s.add(new DPoint(0,0)); s.add(new DPoint(0,1));
	 * s.add(new DPoint(0.5,1)); s.add(new DPoint(0.5,0)); s.add(new
	 * DPoint(1,0)); System.out.println(s.toString()+": " +s.norm());
	 * 
