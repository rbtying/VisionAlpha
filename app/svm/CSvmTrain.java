...
public class CSvmTrain {
	...
	public CSvmTrain(Data data, double C_, double tau_, double eps_, int type_,
	...
	public void train() {
		...
		for (p = 0; p < numLabels - 1; p++) {
			for (n = p + 1; n < numLabels; n++) {
				...
				smo = new CSmo1(kernel, nodeTarget, C, tau, eps);
	...
	public static void main(String[] argv) throws Exception {
		...
		csvm = new CSvmTrain(data, C, tau, eps, type, degree, factor, bias,
				size);
